...
<? $GLOBALS['service'] = carbon_get_post_meta($post->ID,'service');?>


<? $gallery = carbon_get_post_meta($post->ID, 'object_gallery') ?>
        ...
        <section class="single-service">
            <div class="container single-service__container">
                ...
                <div class="single-service__main">
                    <?= wp_get_attachment_image($GLOBALS['image'], 'full') ?>
                    <div class="desc">
